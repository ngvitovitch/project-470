...
class ChoresControllerTest < ActionController::TestCase
  ...
  test "should create chore" do
    assert_difference('Chore.count') do
      post :create, chore: { assigned_user_id: @chore.assigned_user_id, description: @chore.description, dwelling_id: @chore.dwelling_id, name: @chore.name }
    end
  ...
  test "should update chore" do
    put :update, id: @chore, chore: { assigned_user_id: @chore.assigned_user_id, description: @chore.description, dwelling_id: @chore.dwelling_id, name: @chore.name }
    assert_redirected_to chore_path(assigns(:chore))
  end
